...
public class UpdateNote extends HttpServlet {
   ...
   final static String URL = "jdbc:mysql://180.76.60.24/linux_final";
   final static String USER = "root";
   final static String PASS = "aA@123";
   final static String SQL_UPDATE_NOTEPAD = "update notepad set notepadContent=?,notepadTime=? where id=?";
